...
class ANALYSIS:
    ...
    def DefineSelection_0lep(self):#==========[ 0lep REGIONS & SELECTION ]===========================================
        ...
        PS3="("+PS1+")&& Nj8==3";
        PS=" jetAK8puppi_V1_probHww4qvsQCD_a >=0 && jetAK8puppi_V1_probHww4qvsQCD_a <=1 && jetAK8puppi_V1_probHww4q3qvsQCD_a >=0 && jetAK8puppi_V1_probHww4q3qvsQCD_a <= 1 && V1_evqqvsQCD_a >=0 && V1_evqqvsQCD_a <=1 &&  V1_mvqqvsQCD_a>=0 && V1_mvqqvsQCD_a<=1 && V1_emvqqvsQCD_a>=0 && V1_emvqqvsQCD_a <=1 && V1_hadtauvqqvsQCD_a >=0 && V1_hadtauvqqvsQCD_a<=1 && V1_leptaumvqqvsQCD_a>=0 && V1_leptaumvqqvsQCD_a<=1 && V1_leptauevqqvsQCD_a>=0 && V1_leptauevqqvsQCD_a<=1 && Mj_a>30";
        PS4 = " 1 ";
        PS5=" deepWH_Nj2_a == 1 ";
        ...
        SR1b= PS + Low_MET + "&& ( (V1_emvqqvsQCD_a<=0.9 && jetAK8puppi_V1_probHww4q3qvsQCD_a <=0.9 && jetAK8puppi_V1_probHww4q3qvsQCD_a >=0.75)  || (V1_emvqqvsQCD_a<=0.9 && jetAK8puppi_V1_probHww4q3qvsQCD_a<=0.9 && V1_emvqqvsQCD_a>=0.75) ) ";
        SR2a= PS + High_MET + "&& ( V1_emvqqvsQCD_a>=0.9 || jetAK8puppi_V1_probHww4q3qvsQCD_a >=0.9 ) "; 
        SR2b= PS + High_MET + "&& ( (V1_emvqqvsQCD_a<=0.9 && jetAK8puppi_V1_probHww4q3qvsQCD_a <=0.9 && jetAK8puppi_V1_probHww4q3qvsQCD_a >=0.75)  || (V1_emvqqvsQCD_a<=0.9 && jetAK8puppi_V1_probHww4q3qvsQCD_a<=0.9 && V1_emvqqvsQCD_a>=0.75) ) ";

        SR1ab="("+SR1a+") || ("+SR1b+")";
        SR2ab="("+SR2a+") || ("+SR2b+")";

        CR1=PS + Low_MET + "&&  (V1_emvqqvsQCD_a<=0.75 && jetAK8puppi_V1_probHww4q3qvsQCD_a <=0.75)";
        CR2=PS + High_MET + "&&  (V1_emvqqvsQCD_a<=0.75 && jetAK8puppi_V1_probHww4q3qvsQCD_a <=0.75)";
    ...
    def Make_Controlplots_for_0lep(self,selection,selection2,tag,CR=0):
        ...
        if MODE in ["MC","MCvsDATA","DECO"]:
            ...
            #self.construct_plot(Nj,"jetAK8puppi_V1_probHww4qvsQCD_a", selection                    ,"",tag  ,10,  0 , 1    ,"Hww4qvsQCD_a , Nj>=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"pow(jetAK8puppi_V1_probHww4qvsQCD_a,0.2)", selection                    ,"",tag  ,20,  0 , 1    ,"Hww4qvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
          
            #self.construct_plot(Nj,"jetAK8puppi_V1_probHww4q3qvsQCD_a", selection                    ,"",tag  ,10,  0 , 1    ,"Hww4q3qvsQCD_a , Nj>=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"pow(jetAK8puppi_V1_probHww4q3qvsQCD_a,0.2)", selection                    ,"",tag  ,2,  0 , 1    ,"Hww4q3qvsQCD_a , Nj=2"           ,"Events" ,logy,CR); 
            #self.construct_plot(Nj,"V1_evqqvsQCD_a", selection                    ,"",tag  ,10,  0 , 1    ,"HwwevqqvsQCD_a , Nj>=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"pow(V1_evqqvsQCD_a,0.2)", selection                    ,"",tag  ,20,  0 , 1    ,"HwwevqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            #self.construct_plot(Nj,"V1_mvqqvsQCD_a", selection                    ,"",tag  ,10,  0 , 1    ,"HwwmvqqvsQCD_a , Nj>=2"           ,"Events" ,logy,CR);
            # self.construct_plot(Nj,"pow(V1_mvqqvsQCD_a,0.2)", selection                    ,"",tag  ,20,  0 , 1    ,"HwwmvqqvsQCD_a , Nj=2"           ,"Events" ,logy,CR);
            #self.construct_plot(Nj,"V1_emvqqvsQCD_a", selection                    ,"",tag  ,10,  0 , 1    ,"HwwemvqqvsQCD_a(new combined) , Nj>=2"           ,"Events" ,logy,CR);
    ...
    def construct_plot(self,Nj,variable,cut,cut1,tag,nbin,min,max,xtitle="",ytitle="",logy=1,CR=0,Intime=False):
        ...
        if MODE in ["MC","MCvsDATA"]:
            ...
            theLeg.AddEntry(h_Signal1,"lvqq #times %s "%(NORM_s1),"L");
            theLeg.AddEntry(h_Signal2,"4q #times %s "%(NORM_s1),"L");
